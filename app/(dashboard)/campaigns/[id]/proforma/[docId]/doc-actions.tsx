  ...
  return (
    <>
        ...
        <div className="bg-blue-50 border border-blue-200 rounded-xl px-5 py-4 space-y-3">
          ...
          <div className="flex gap-3">
            ...
            <button
              ...
              className="min-h-[44px] px-4 py-2.5 rounded-lg border border-gray-200 text-sm font-medium text-gray-700 hover:bg-gray-50 transition"
            >
              Cancel
            </button>
          </div>
      ...
      <div className="flex justify-end gap-3 flex-wrap">
        ...
        <a
          href={pdfHref}
          download={`proforma-${documentNumber}.pdf`}
        ...
        {/* Clone — all statuses (admin/exec/planner only) */}
        {canClone && (
          <button
        ...
        {!isReadOnly && canEdit && (
          <>
            {isDraft && (
              <>
                <Link
                  href={`/campaigns/${campaignId}/proforma/${docId}/edit`}
